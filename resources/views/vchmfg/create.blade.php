...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('vchmfg.store') }}" id="fg-form" method="POST" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="row g-2">
                    ...
                    <div class="col-xxl-3 col-md-3">
                        <label for="exampleFormControlTextarea5" class="">Godown<span
                                class="text-danger font-weight-bold">*<a href="{{ route('godown.create') }}"
                                    style=color:red;>(Add
                                    Godown)</a></span></label>
                        <select class="form-select form-control" autofocus aria-label="Default select example"
                            id="godown_id" name="godown_id">
                    ...
                    <div class="col-xxl-2 col-md-3">
                        <label for="exampleFormControlTextarea5" class="">Machines<span
                                class="text-danger font-weight-bold">*<a href="{{ route('machine.create') }}"
                                    style=color:red;>(Add
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="start_reading" id="start_reading"
                            value="{{ old('start_reading', '') }}" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="end_reading" id="end_reading"
                            value="{{ old('end_reading', '') }}" required>
                    </div>
            ...
            <div class="row gx-5 mt-4">
                <div class="col-md-12">
                    <form method="post" action="" id="product_form">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Finish Good <span class="text-danger font-weight-bold">*<a
                                            href="{{ route('item.create') }}" style=color:red;>(Add
                                            Item)</a></span></label>
