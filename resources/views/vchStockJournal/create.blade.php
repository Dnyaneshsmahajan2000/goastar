    ...
    <div class="card">
        <div class="card-header p-2 bg-primary ">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a title="Alt + A" id='view-all-button' href='{{ @route('vchstockjournal.index') }}'
        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('vchstockjournal.store') }}" id="fg-form" method="POST" class="needs-validation"
                    novalidate>
            ...
            $('#product_form').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        $("#item_list").load(
                            '{{ route('vchstockjournal.item.list') }}');
                        $('#item_id').val('');
                        $('#item_name').val('');
                        $('#quantity').val('');
                        $('#godown_id').val('');
