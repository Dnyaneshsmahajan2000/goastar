...
@section('content')
    ...
    <div class="card">
        <div class="card-header p-2 bg-primary ">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a title="Alt + A" id='view-all-button' href='{{ @route('vchjournal.index') }}'
        ...
        <div class="card-body">
            ...
            <form action="{{ route('vchjournal.update', $id) }}" id="fg-form" method="POST" class="needs-validation"
                novalidate>
                @method('PUT')
                    ...
                    <form method="post" action="" id="product_form">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-sm" name="ledger_name"
                                    id="ledger_name" required="" autofocus style="text-transform:capitalize">
