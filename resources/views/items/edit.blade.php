@extends('layouts.app', ['title' => 'Update Item'])
@section('content')
    <div class='row'>
        <div class='col-lg-12'>
            <div class="card">
                <div class="card-header p-2 bg-primary ">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <a title="Alt + A" id='view-all-button' href='{{ @route('item.index') }}'
                               ...
                               <div class="col-xxl-4 col-md-3">
                                    <div>
                                        ...
                                        <select class="form-control form-select" name="unit" id="unit">
                                            ...
                                            <option value="Liter" {{ $item->unit == 'Liter' ? 'selected' : '' }}>Liter (ltr)</option>
                                            <option value="Kilogram" {{ $item->unit == 'Kilogram' ? 'selected' : '' }}>Kilogram (kg)</option>
                                            <option value="Gram" {{ $item->unit == 'Gram' ? 'selected' : '' }}>Gram (g)</option>
                                            <option value="Tonne" {{ $item->unit == 'Tonne' ? 'selected' : '' }}>Tonne (ton)</option>
                                            <option value="Quintal" {{ $item->unit == 'Quintal' ? 'selected' : '' }}>Quintal (qtl)</option>
                                            <option value="Box" {{ $item->unit == 'Box' ? 'selected' : '' }}>Box</option>
                                            <option value="Mililiter" {{ $item->unit == 'Mililiter' ? 'selected' : '' }}>Mililiter (ml)</option>
                                            <option value="Pack" {{ $item->unit == 'Pack' ? 'selected' : '' }}>Pack unit</option>
                                        </select>
                                        @error('unit')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
