            ...
            <div class="table-responsive">
                ...
                <div class="row">
                    @foreach ($games as $game)
                        @php
                             $game_result = \App\Models\Result::where('game_id', $game->id)
                        ...
                        <div class="col-md-3 mb-4">
                            <form action="{{ $game_result ? route('results.closeSave' , $game_result->id) : route('results.openSave') }}"
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                                    <h5>
                                                        ...
                                                        {{ ucwords($game->game_name_en) }}  ({{ ucwords($game->game_name_mr) }})
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <h5>
                                                        {{date('H:i',strtotime($game->open_time))  }}
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($now > $openTime)
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="open_3" class="form-label">Open_3 Digit</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="open_1" class="form-label">Open_1 Digit</label>
                                        ...
                                        @if ($now > $closeTime and $game_result)
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="close_3" class="form-label">Close_3 Digit</label>
                                                        <input type="number" class="form-control" id="close_3"
                                                            name="close_3" oninput="calculateSumAndSetLastDigitofclose()" <?php echo isset($game_result->close_3) ? "value='" . $game_result->close_3 . "' readonly" : ''; ?>>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="close_1" class="form-label">Close_1 Digit</label>
                                                        <input type="number" class="form-control" id="close_1"
                                                            name="close_1" <?php echo isset($game_result->close_1) ? "value='" . $game_result->close_1 . "' readonly" : ''; ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <script>
