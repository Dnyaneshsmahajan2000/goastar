        ...
        <div class="card-header p-2 bg-primary">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a title="Alt + A" id='view-all-button' href='{{ route('vch.create', ['vch_type' => $vch_type]) }}'
                        ...
                        @foreach ($Vouchers as $voucher)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul>
                                        @foreach ($voucher->VchNonGstItems as $item)
                                ...
                                <td>
                                    <a class="btn btn-sm btn-primary"
                                        href="{{ route('vch.edit', [$voucher->vch_type, $voucher->id]) }}">Edit</a>
                                    <form class="d-inline"
                                        action="{{ route('vch.destroy', [$voucher->vch_type, $voucher->id]) }}"
                                        method="post">
