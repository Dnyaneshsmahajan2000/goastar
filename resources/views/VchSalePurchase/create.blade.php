...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            //print_r($voucher)
            ?>
            <form action="{{ route('vch.store', ['vch_type' => $vch_type]) }}" id="fg-form" method="POST"
                ...
                <div class="row g-2">
                    ...
                    <div class="col-xxl-2 col-md-2">
                        ...
                        <input type="hidden" class="form-control form-control-sm" name="total_bill" id="total_bill" />
                    ...
                    <div class="col-xxl-2 col-md-3">
                        ...
                        <input type="hidden" class="form-control form-control-sm" name="ledger_id" id="ledger_id"
                            value="<?php //echo $ledger_id;
                            ?>">
                        <input type="text" name="ledger_name" id="ledger_name" autofocus
                            class="form-control form-control-sm" value="<?php //echo $ledger_name;
                            ?>">
                    ...
                    <div class="col-xxl-2 col-md-2             ">
                        ...
                        <select class="form-control form-select form-select-sm" autofocus required=""
                            ...
                            @foreach ($godowns as $godown)
                                <option value=" {{ $godown['id'] }}" <?php //echo $_SESSION['user']['gd_id'] === $data['gd_id'] ? 'selected' : '';
                                ?>>
                                    {{ $godown['name'] }}
                                </option>
                            @endforeach
