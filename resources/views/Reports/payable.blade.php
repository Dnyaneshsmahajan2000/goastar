@extends('layouts.app', ['title' => 'Payable Report'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('report.payable') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
        ...
        <div class="col-lg-12">
            <div class="card p-2">
                <div class="card-header text-center bg-primary text-white">
                    <h4 class="text-white">Payable Report {{ isset($group_name) ? $group_name : '' }}</h4>
